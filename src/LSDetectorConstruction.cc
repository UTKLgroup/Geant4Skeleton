...
void LSDetectorConstruction::BuildMaterial() {
  ...
  // Dung's LAr Scintilation correctionstatic const G4double inch = 2.54*cm;
  ...
  G4double LAr_RIndEnergy[] = {1.900*eV,  21000.934*eV,  3.592*eV,  5.566*eV,  6.694*eV,  7.540*eV,  8.574*eV,  9.044*eV,  9.232*eV, 9.420*eV,  9.514*eV,  9.608*eV,  9.702*eV,  9.796*eV,  9.890*eV,  9.984*eV,  10.08*eV,  10.27*eV,  10.45*eV,  10.74*eV,  10.92*eV};
